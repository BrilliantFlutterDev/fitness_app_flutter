...
class RemoveAd extends StatefulWidget {
  const RemoveAd({Key? key}) : super(key: key);

  @override
  State<RemoveAd> createState() => RemoveAdState();
}

class RemoveAdState extends State<RemoveAd> {
